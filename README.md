...
To determine the lower bound for $d$, we consider the fact that there are $2^n$ unique values of $t$ and $2^d$ available slots for those values. Consequently, $2^d \geq 2^n$, implying that $d \geq n$. We choose $d = 6$.
